...
public class ArithmeticProgressionCheckerTest {
    ...
    public void testArithmeticProgression() {
        ...
        boolean actual = ArithmeticProgressionChecker.isArithmeticProgression(new int[]{1, 3, 5, 7});
    ...
    public void testAnotherArithmeticProgression() {
        boolean expected = true;
        boolean actual = ArithmeticProgressionChecker.isArithmeticProgression(new int[]{10, 20, 30, 40});
        assertEquals(expected, actual, "The array should form an arithmetic progression.");
    }
    ...
    public void testNotAnArithmeticProgression1() {
        ...
        boolean actual = ArithmeticProgressionChecker.isArithmeticProgression(new int[]{1, 2, 4, 8});
    ...
    public void testNotAnArithmeticProgression2() {
        boolean expected = false;
        boolean actual = ArithmeticProgressionChecker.isArithmeticProgression(new int[]{1, 2, 3, 5});
        assertEquals(expected, actual, "The array should not form an arithmetic progression.");
    }
    ...
    public void testSingleElement() {
        boolean expected = true;
        boolean actual = ArithmeticProgressionChecker.isArithmeticProgression(new int[]{2});
    ...
    public void testEmptyArray() {
        boolean expected = true;
        boolean actual = ArithmeticProgressionChecker.isArithmeticProgression(new int[]{});
